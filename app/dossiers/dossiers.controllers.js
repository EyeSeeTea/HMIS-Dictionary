...
dossiersModule.controller("dossiersMainController", [
    ...
    "dossiersServiceIndicatorGrpsFactory",
    function (
        $scope,
        $translate,
        $anchorScroll,
 ...
 *  @description
 */
dossiersModule.controller("dossiersSectionController", [
    "$scope",
    "$translate",
    "dossiersSectionsFactory",
    "Ping",
    function ($scope, $translate, dossiersSectionsFactory, Ping) {
        /*
         *  @name filterSections
 ...
 * @description
 */
dossiersModule.controller("dossiersElementsTableController", [
    "$scope",
    function ($scope) {
        /*
 ...
 * @description
 */
dossiersModule.controller("dossiersIndicatorController", [
    "$scope",
