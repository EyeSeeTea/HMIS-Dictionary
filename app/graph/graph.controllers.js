...
graphModule.controller("graphMainController", [
    "$scope",
    "$translate",
    "dossiersServicesFactory",
    "dossiersServiceDataSetsFactory",
    "dossiersSectionsFactory",
    function ($scope, $translate, dossiersServicesFactory, dossiersServiceDataSetsFactory, dossiersSectionsFactory) {
        ping();
        ...
        $scope.$watch("loaded", function () {
            if ($scope.loaded) {
                ...
                var gnode = svg.append("g").selectAll(".nodes").data(nodeList).enter();
                ...
                $scope.nodeSelected = function (selected) {
                    if (selected) {
                        ...
                        if (selectedVal == "none") {
                            ...
                            d3.selectAll(".nodes, .links, text").transition().duration(5000).style("opacity", 1);
                        }
                    } else {
