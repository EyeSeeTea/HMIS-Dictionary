...
adminModule.factory("adminUGFactory", [
    "$resource",
    function ($resource) {
        return {
...
adminModule.factory("adminOUGSFactory", [
    "$resource",
    function ($resource) {
        return {
...
adminModule.factory("adminIGFactory", [
    "$resource",
    function ($resource) {
        return {
...
adminModule.factory("adminOUGFactory", [
    "$resource",
    function ($resource) {
        return $resource(
            qry_get_OUG,
...
adminModule.factory("adminDossierConfigCompleteFactory", [
    "$resource",
    function ($resource) {
        return {
            get_dossierConfigComplete_set: $resource(
                qry_set_dossierConfigComplete,
                {},
                { query: { method: "GET", isArray: false } }
            ),
            set_dossierConfigComplete: $resource(
                qry_set_dossierConfigComplete,
                {},
                { query: { method: "POST", isArray: false } }
            ),
            upd_dossierConfigComplete: $resource(
                qry_set_dossierConfigComplete,
                {},
