...
dossierIndicatorsModule.controller('dossierIndicatorsMainController',['$scope','$translate','$anchorScroll','$sessionStorage','$sce','dossiersIndicatorsFactory','dossierIndicatorsDataElementsFactory','dossierIndicatorsDataSetsFactory','dossierIndicatorsCategoryOptionComboFactory','dossierIndicatorsProgramIndicatorsFactory','dossierIndicatorsOrganisationUnitGroupsFactory','dossierIndicatorsProgramsFactory','dossierIndicatorsLink',function($scope,$translate,$anchorScroll,$sessionStorage,$sce,dossiersIndicatorsFactory,dossierIndicatorsDataElementsFactory,dossierIndicatorsDataSetsFactory,dossierIndicatorsCategoryOptionComboFactory,dossierIndicatorsProgramIndicatorsFactory,dossierIndicatorsOrganisationUnitGroupsFactory,dossierIndicatorsProgramsFactory,dossierIndicatorsLink)
{
...
dossierIndicatorsModule.controller('dossierIndicatorsTitle',['$scope','$q','dossierIndicatorsDataElementsFactory','dossierIndicatorsCategoryOptionComboFactory','dossierIndicatorsProgramIndicatorsFactory','dossierIndicatorsOrganisationUnitGroupsFactory','dossierIndicatorsProgramsFactory','dossierIndicatorsDataSetsFactory','dossierIndicatorsLink','Ping',function($scope,$q,dossierIndicatorsDataElementsFactory,dossierIndicatorsCategoryOptionComboFactory,dossierIndicatorsProgramIndicatorsFactory,dossierIndicatorsOrganisationUnitGroupsFactory,dossierIndicatorsProgramsFactory,dossierIndicatorsDataSetsFactory,dossierIndicatorsLink,Ping)
{
   ...
   function getInformation(value)
   {
      ...
      for(var i=0;i<value.length;i++) 
      {
         ...
         if(value[i][1] === "G")//OrganisationUnitGroups
         {
...
dossierIndicatorsModule.controller('dossierNumeratorTable',['$scope','$q','$sessionStorage','dossierIndicatorsDataElementsFactory','dossierIndicatorsCategoryOptionComboFactory','dossierIndicatorsProgramIndicatorsFactory','dossierIndicatorsOrganisationUnitGroupsFactory','dossierIndicatorsProgramsFactory','dossierIndicatorsDataSetsFactory','dossierIndicatorsLink','Ping',function($scope,$q,$sessionStorage,dossierIndicatorsDataElementsFactory,dossierIndicatorsCategoryOptionComboFactory,dossierIndicatorsProgramIndicatorsFactory,dossierIndicatorsOrganisationUnitGroupsFactory,dossierIndicatorsProgramsFactory,dossierIndicatorsDataSetsFactory,dossierIndicatorsLink,Ping)
{
   function getElement(value)
   {
      var i = 0, position = 0; 
         ...
         $q.all(promiseNumeratorTable).then(function(arr)
         {
            ...
            arr.forEach(function(response)
            {
               ...
               if(dataSetId.length > 0)
               {
                  ...
                  {
                     tabPromiseDataSets.push(dossierIndicatorsDataSetsFactory.get({id: dataSetId[y]}).$promise);
                  }
               }
               else
               {
               ...
               for(var i=0; i<numeratorTable.length; i++)
               {
                  ...
                  if(numeratorTable[i][1]==="#")
                  {
                     ...
                     if(tabResult[indexTabResult][1] !== undefined)
                     {
                        ...
                        {
                           tabRegroupNameDataSets.push(tabResultDataSets[indexTabResultDataSets].toString());
...
dossierIndicatorsModule.controller('dossierDenominatorTable',['$scope','$q','$sessionStorage','dossierIndicatorsDataElementsFactory','dossierIndicatorsCategoryOptionComboFactory','dossierIndicatorsProgramIndicatorsFactory','dossierIndicatorsOrganisationUnitGroupsFactory','dossierIndicatorsProgramsFactory','dossierIndicatorsDataSetsFactory','dossierIndicatorsLink','Ping',function($scope,$q,$sessionStorage,dossierIndicatorsDataElementsFactory,dossierIndicatorsCategoryOptionComboFactory,dossierIndicatorsProgramIndicatorsFactory,dossierIndicatorsOrganisationUnitGroupsFactory,dossierIndicatorsProgramsFactory,dossierIndicatorsDataSetsFactory,dossierIndicatorsLink,Ping)
{
   function getElement(value)
   {
      var i = 0, position = 0; 
   ...
   $scope.$watch('selectedIndicator',function() 
   {
      ...
      {
         startLoadingState(false);
         var tableDenominator = creationArray4Table(parseElement(getElement($scope.selectedIndicator.denominator)));
         ...
         $q.all(promiseDenominatorTable).then(function(arr)
         {
            ...
            arr.forEach(function(response)
            {
               ...
               var nameDenominator = response[denominatorElementMapping[indexDenominator]].map(function(data){
                  return data.name;
               });
               var dataElementDenominator = response[denominatorElementMapping[indexDenominator]].map(function(data)
               {
                     return data.dataSetElements;
               });
               ...
               {
                  tabDenominator.push(nameDenominator.toString(),dataSetIdDenominator.length,dataSetIdDenominator); 
                  for(var y=0; y< dataSetIdDenominator.length; y++) 
                  {
                     tabPromiseDataSetsDenominator.push(dossierIndicatorsDataSetsFactory.get({id: dataSetIdDenominator[y]}).$promise);
                  }
               }
               else
               {
               ...
               for(var i=0; i<denominatorTable.length; i++)
               {
                  if(denominatorTable[i][1]==="#")
                  {
                     ...
                     if(tabResultDenominator[indexTabResultDenominator][1] !== undefined)
                     {
                        ...
                        {
                           tabRegroupNameDataSetsDenominator.push(tabResultDataSetsDenominator[indexTabResultDataSetsDenominator].toString());
