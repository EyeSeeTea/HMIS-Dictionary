...
dossiersEditorModule.controller("dossiersEditorMainController", [
    "$scope",
    ...
    function (
        ...
        $scope.tinymceOptions = {
            ...
            toolbar:
                "insertfile undo redo | styleselect | fontsizeselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | table | preview",
                ...
                $scope.translation = dossiersEditorTranslationsFactory.get(
                    ...
                    function () {
                        ...
                        $scope.translation.translations.forEach(function (translation) {
                            if (
                                translation.locale != $scope.selectedLanguage.code ||
